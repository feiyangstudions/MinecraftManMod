...
public class GoldenIceTeaItem extends DrinkableItem {

    public GoldenIceTeaItem(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, Item.TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        addDelimiter();
        add("tooltip.fystu_man.golden_ice_tea.line1");
        addDelimiter();
        add("tooltip.fystu_man.__ALL__.super_effect");
        add("tooltip.fystu_man.golden_ice_tea.line2");
        addDelimiter();
    }
}
